        ...
        <div className="container p-4 pt-[100px] mx-auto">
           ...
           ${showMobileFilter ? 'translate-x-0' : 'translate-x-full'} md:translate-x-0`}
                >
                    ...
                    {/* Sort */}
                    <div>
                        <h3 className="pb-2 font-medium uppercase border-b text-slate-500 border-slate-300">Sort by</h3>
                ...
                <div className="flex-1 md:ml-0">
                    ...
                    <h2 className="mb-4 text-xl font-bold">Tất cả sản phẩm ({products.length})</h2>
