...
const Cart = () => {
    ...
    return (
        <div className="container px-4 py-6 pt-20 mx-auto">
                                        ...
                                        <tr key={product._id} className="border-b border-gray-200 hover:bg-gray-50">
                                            <td className="w-2/5 py-3">
                                                <div className="flex items-center gap-4">
                                                    <img
                                                        ...
                                                        alt={product?.productId?.productName || 'Sản phẩm'}
                                                        className="flex-shrink-0 object-contain w-20 h-20 rounded"
                                                    />
                                            ...
                                            <td className="py-3 text-center w-[15%]">
                                                <div className="flex items-center justify-center gap-2">
                                                    <button
                                                        ...
                                                        className="flex items-center justify-center w-8 h-8 border border-gray-300 rounded hover:bg-gray-200"
                                                    >
                                                        <FaMinus size={12} />
                                                    </button>
                                            ...
                                            <td className="py-3 text-center w-[10%]">
                                                <button
                                                    ...
                                                    className="p-2 text-red-600 rounded hover:text-yellow-500"
                                                >
                    ...
                    {loading ? (
                        ...
                        <div className="p-4 bg-white border border-gray-200 rounded">
                            ...
                            <button
                                ...
                                className="w-full py-2 mt-3 text-white bg-red-600 rounded hover:bg-red-700"
                            >
                                Thanh toán VNPay
                            </button>
