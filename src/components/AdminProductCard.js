    ...
    return (
        <div className="w-full max-w-[220px] p-4 bg-white rounded-lg shadow-md hover:shadow-lg flex flex-col items-center">
            <div className="flex items-center justify-center w-full h-40">
                <img
                    src={data.productImage && data.productImage[0] ? data.productImage[0] : ''}
            ...
            <div className="flex items-center justify-between w-full mt-2">
                ...
                <button
                    type="button"
                    className="p-2 bg-green-100 rounded-full cursor-pointer hover:bg-green-600 hover:text-white"
            ...
            {editProduct && <AdminEditProduct productData={data} onClose={handleCloseEdit} fetchdata={fetchdata} />}
        </div>
    );
};
